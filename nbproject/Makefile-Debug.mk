...
${OBJECTDIR}/_ext/471842843/fromFile.o: /home/y2l1/Dropbox/NetBeansProjects/Projects_C/Trabalho_Pratico_C/fromFile.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/471842843/fromFile.o /home/y2l1/Dropbox/NetBeansProjects/Projects_C/Trabalho_Pratico_C/fromFile.c

${OBJECTDIR}/_ext/471842843/toFile.o: /home/y2l1/Dropbox/NetBeansProjects/Projects_C/Trabalho_Pratico_C/toFile.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/471842843
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/471842843/toFile.o /home/y2l1/Dropbox/NetBeansProjects/Projects_C/Trabalho_Pratico_C/toFile.c

${OBJECTDIR}/additionalFunctions.o: additionalFunctions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/additionalFunctions.o additionalFunctions.c

${OBJECTDIR}/date.o: date.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/date.o date.c

${OBJECTDIR}/garage.o: garage.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/garage.o garage.c
...
${OBJECTDIR}/material.o: material.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/material.o material.c

${OBJECTDIR}/mechanic.o: mechanic.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mechanic.o mechanic.c

${OBJECTDIR}/speciality.o: speciality.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/speciality.o speciality.c
